    ...
    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
      ...
      <div class="accordion" id="profileAccordion">
        <div class="accordion-item">
          ...
          <div id="profileCollapse" class="accordion-collapse collapse show" aria-labelledby="profileHeading" data-bs-parent="#profileAccordion">
            <div class="accordion-body">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="../my-profile/">
      ...
      <div class="accordion" id="graveAccordion">
        <div class="accordion-item">
          <h2 class="accordion-header" id="graveHeading">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#graveCollapse" aria-expanded="false" aria-controls="graveCollapse">
              <i class="bi bi-map me-2"></i> Grave Management
            </button>
          </h2>
          <div id="graveCollapse" class="accordion-collapse collapse" aria-labelledby="graveHeading" data-bs-parent="#graveAccordion">
            <div class="accordion-body">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="../../grave-management/grave-locator/">
                    <i class="bi bi-pin-map"></i> Grave Locator
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="../../grave-management/my-reservations/">
                    <i class="bi bi-calendar-check"></i> My Reservations
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="../../grave-management/maintenance-requests/">
